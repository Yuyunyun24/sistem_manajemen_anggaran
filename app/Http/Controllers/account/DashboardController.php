...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        $debit = $uang_masuk_selama_ini->nominal;
        $kredit = $uang_keluar_selama_ini->nominal;
        ...
        return view('account.dashboard.index', compact('saldo_selama_ini','saldo_bulan_ini', 'saldo_bulan_lalu', 'debit', 'kredit'));
    }
